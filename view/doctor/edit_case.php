    ...
    <div class="tab-content">
        <div class="tab-pane fade active in" id="t1">
            <div class="t-top col-xs-12">
             ...
             <?php   include get_template_directory() . '/view/parts/edit_case_top_btn.php';  ?>
            </div>
                    ...
                    <div class="f-item col-md-4 col-xs-12">
                      ...
                      <!--   <div class="form-group">
                       ...
                       <!-- <div class="form-group">
                        ...
                        <div class="form-group">
                       	<?php $smooker = get_field('smooker',intval($_GET['edit_case']));
                              ?>
                            <h4>Smoker status</h4>
                            <label>
                        ...
                        <!-- <div class="form-group">
                            <?php $ex_smoker = get_field('ex-smoker',intval($_GET['edit_case']));
                              ?>
                            <h4>Ex-smoker</h4>
                            <label>
                                <input type="radio" value="1" name="ex-smoker" <?php if ($ex_smoker =='1'){echo 'checked';} ?>>
                                <span>yes</span>
                            </label>
                            <label>
                                <input type="radio" name="ex-smoker" value="0" <?php if ($ex_smoker =='0'){echo 'checked';} ?>>
                                <span>no</span>
                            </label>
                        </div> -->
                    </div>
                            ...
                            <select class="form-control" name="country_">
								...
								<?php if ($country->have_posts()): while ($country->have_posts()):$country->the_post(); ?>
                                    <option value="<?php echo get_the_ID(); ?>"
									        <?php if ($country_ == get_the_ID()): ?>selected <?php endif; ?>><?php the_title(); ?></option>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            <select class="form-control" name="occupation">
								...
								<?php if ($country->have_posts()): while ($Occupation->have_posts()):$Occupation->the_post(); ?>
                                    <option value="<?php echo get_the_ID(); ?>"
									        <?php if ($occupation == get_the_ID()): ?>selected <?php endif; ?>><?php the_title(); ?></option>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <select class="form-control" name="education_level">
								...
								<?php if ($Education->have_posts()): while ($Education->have_posts()):$Education->the_post(); ?>
                                    <option <?php if ($education_level == get_the_ID()): ?>selected
									        <?php endif; ?>value="<?php echo get_the_ID(); ?>"><?php the_title(); ?></option>
								<?php endwhile; endif;
								wp_reset_query(); ?>
        ...
        <div class="tab-pane fade" id="t2">
            ...
            <div class="t-bottom col-xs-12">
                <form id="step_2form" action="#">
                    <div class="f-item col-md-8 col-xs-12">
                         <div class="form-group col-md-6 col-xs-12">
                              <?php $first_joint_symptoms = get_field('first_joint_symptoms',intval($_GET['edit_case']));
                              ?>
							...
							<br />
							<?php $were_these_symptoms_initially_palindromic = get_field('were_these_symptoms_initially_palindromic',intval($_GET['edit_case']));
                              ?>
							<!-- <h5>Were these symptoms initially palindromi</h5>
								...
								<?php $medical_insurance = get_field('medical_insurance',intval($_GET['edit_case']));
                              ?>
						...
						<br /><br />
                             ...
                             <?php $number_of_visits = get_field('number_of_visits',intval($_GET['edit_case']));
                              ?>
                                    ...
                                    <br />
                                     <?php $family_history_of_autoimmune_disease = get_field('family_history_of_autoimmune_disease',intval($_GET['edit_case']));
                              ?>
                      ...
                      <!--  <div class="form-group col-md-6 col-xs-12">
                           ...
                           <div class="form-group col-md-6 col-xs-12">
                       <?php $initial_referral_to_rheumatologist_from = get_field('initial_referral_to_rheumatologist_from',intval($_GET['edit_case']));
                              ?>
                        	...
                        	<div class="form-group col-md-6 col-xs-12">
                         <?php $family_history_of_arthritis = get_field('family_history_of_arthritis',intval($_GET['edit_case']));
                              ?>
                      ...
                      <!--  <div class="form-group col-md-6 col-xs-12">
                       ...
                       <!-- <div class="form-group col-md-6 col-xs-12">
                            <h4>Family History Of Rheumatoid Arthritis</h4>
                            <label>
                    ...
                    <div class="f-item col-md-12 col-xs-12">
                        ...
                        <div class="form-group col-md-12 col-xs-12">
                            ...
                            <div class="sm-item col-xs-12">
                                <?php $morning_stifness = get_field('morning_stifness',intval($_GET['edit_case']));
                              ?>
                            ...
                            <div class="sm-item col-xs-12">
                                <?php $joint_pain = get_field('joint_pain',intval($_GET['edit_case']));
                              ?>
                                <h5>Joint Pain</h5>
                                <ul>
                                    <li>
                            ...
                            <div class="form-group col-md-6 col-xs-12">
                            <div class="sm-item col-xs-12">
                                  <?php $joint_swelling = get_field('joint_swelling',intval($_GET['edit_case']));
                              ?>
                           ...
                           <!-- <div class="sm-item col-xs-12">
                                <?php $skin_rash = get_field('skin_rash',intval($_GET['edit_case']));
                              ?>
                                <h5>Skin Rash</h5>
                                <ul>
                                    <li>
                            ...
                            <div class="sm-item col-xs-12">
                                <?php $malignancy = get_field('malignancy',intval($_GET['edit_case']));
                              ?>
                                <h5>Malignancy</h5>
                                <ul>
                                    <li>
                ...
                <form action="#" method="get" id="form_step_3">
                    <div class="f-item col-md-8 col-xs-12">
                      <!--  <div class="form-group col-md-6 col-xs-12">
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                       	<?php $squeeze_test = get_field('squeeze_test',intval($_GET['edit_case']));
                              ?>
                            <h4>Squeeze Test</h4>
                            <ul>
                            <label>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            <?php $swelling = get_field('swelling',intval($_GET['edit_case']));
                              ?>
                            <h4>Swelling </h4>
                            <ul>
                            <label>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            <?php $tendernes = get_field('tendernes',intval($_GET['edit_case']));
                              ?>
                            <h4>Tendernes</h4>
                            <ul>
                            <label>
                     ...
                     <div class="f-head col-xs-12">
                        ...
                        <div class="form-group col-md-4 col-xs-12">
                           <!-- <div class="sm-item">
                               <?php $working_diagnosis = get_field('working_diagnosis',intval($_GET['edit_case']));
                              ?>
                           ...
                           <div class="sm-item">
                                 <?php $rf_serology = get_field('rf_serology',intval($_GET['edit_case']));
                              ?>
                            <h4>RF serology</h4>
                            <ul>
                            <label>
                           ...
                           <div class="sm-item">
                                  <?php $anti_ccp = get_field('anti_ccp',intval($_GET['edit_case']));
                              ?>
                            <h4>Anti-CCP</h4>
                            <ul>
                            <label>
                           ...
                           <div class="sm-item">
                             <?php $ana = get_field('ana',intval($_GET['edit_case']));
                              ?>
                            <h4>ANA</h4>
                            <ul>
                            <label>
                           ...
                           <div class="sm-item">
                                <?php $anti_ssa = get_field('anti-ssa',intval($_GET['edit_case']));
                              ?>
                                <h4>Anti-SSA</h4>
                                <ul>
                                    <label>
                             ...
                             <div class="sm-item">
                                  <?php $anti_ssb = get_field('anti-ssb',intval($_GET['edit_case']));
                              ?>
                                <h4>Anti-SSB</h4>
                                <ul>
                                    <label>
                         ...
                         <div class="form-group col-md-4 col-xs-12">
                             ...
                             <div class="sm-item">
                                 <?php $apa = get_field('apa',intval($_GET['edit_case']));
                              ?>
                            <h4>APA</h4>
                            <ul>
                            <label>
                           ...
                           <label>
                             ...
                             <div class="sm-item">
                                  <?php $quantiferontb_gold = get_field('quantiferontb_gold',intval($_GET['edit_case']));
                              ?>
                              ...
                              <div class="sm-item">
                                  <?php $hepatitis_b = get_field('hepatitis_b',intval($_GET['edit_case']));
                              ?>
                            <h4>HBsAg</h4>
                            <ul>
                            <label>
                           ...
                           <label>
                            ...
                            <label>
                              ...
                              <div class="sm-item">
                               <?php $hbsab = get_field('hbsab',intval($_GET['edit_case']));
                              ?>
                                <h4>HBsAb</h4>
                                <ul>
                                    <label>
                              ...
                              <div class="sm-item">
                                  <?php $hbcab = get_field('hbcab',intval($_GET['edit_case']));
                              ?>
                                <h4>HBcAb</h4>
                                <ul>
                                    <label>
                        ...
                        <div class="form-group col-md-4 col-xs-12">
                             ...
                             <div class="sm-item">
                                 <?php $hepatitis_c = get_field('hepatitis_c',intval($_GET['edit_case']));
                              ?>
                            <h4>HCVAb</h4>
                            <ul>
                            <label>
                           ...
                           <label>
                            ...
                            <label>
                             ...
                             <div class="sm-item">
                                 <?php $lft_ = get_field('lft_',intval($_GET['edit_case']));
                              ?>
                                <h4>LFT</h4>
                                <ul>
                                    <label>
                             ...
                             <div class="sm-item">
                                 <?php $renal_function_ = get_field('renal_function_',intval($_GET['edit_case']));
                              ?>
                             ...
                             <div class="sm-item">
                                 <?php $hiv = get_field('hiv',intval($_GET['edit_case']));
                              ?>
                            <h4>HIV</h4>
                            <ul>
                            <label>
